...
> Рассмотрим функцию $y = \operatorname{ctg x}:X \subset \mathbb{R^{\pm\infty}}\rightarrow Y \subset \mathbb{R^{\pm\infty}}$ определенные в некоторой окрестности $U(x_0, \varepsilon)$. Тогда производная $\operatorname{tg x}$ равна $\displaystyle-\frac{1}{\sin^2x}$ $$\operatorname{ctg x}' =  -\frac{1}{\sin^2x}$$
> > [!proof]- Доказательство
...
> Рассмотрим функцию $y = \operatorname{arctg }x:X \subset \mathbb{R^{\pm\infty}}\rightarrow Y \subset \mathbb{R^{\pm\infty}}$ определенные в некоторой окрестности $U(x_0, \varepsilon)$. Тогда производная $\operatorname{arctg }x$ равна $\displaystyle\frac{1}{1+x^2}$ $$\operatorname{arctg }x' =  \frac{1}{1+x^2}$$
> > [!proof]- Доказательство
